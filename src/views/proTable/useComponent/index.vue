<template>
  <div class="table-box">
    <ProTable ref="proTable" :requestApi="getUserTableList" :initParam="initParam" :columns="columns">
      <!-- 表格 header 按钮 -->
    ...
    <BaseDialog v-if="dialogVisible" :visible="dialogVisible" title="测试" @cancel="handleCancel" @submit="handleSubmit">
      这是内容
    </BaseDialog>
